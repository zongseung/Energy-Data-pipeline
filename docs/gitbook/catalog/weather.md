...
**요소 12종**: 1시간기온 · 습도 · 풍속 · 하늘상태 · 강수확률 · 1시간강수량 · 1시간적설 · 강수형태 · 일최고기온 · 일최저기온 · 동서바람성분 · 남북바람성분
...
**알려진 품질 이슈**: 초단기실황 기온이 한겨울 새벽에 시간당 1\~2℃씩 오르는 구간을 확인했습니다(예: 청운효자동 2024-01-01 00시 2.7℃ → 02시 6.1℃). 원천 파일과 대조해보니 파싱 오류가 아니라 **원천 데이터 자체의 문제**입니다. 실황값을 관측 진실값으로 쓰기 전에 `research.weather_asos`(ASOS 실측)와 대조하세요.
